...
export const coverageEligibilityRequestSchema = untypedCoverageEligibilityRequestSchema
...
export class FhirCoverageEligibilityRequest extends FhirDomainResource<CoverageEligibilityRequest> {
  ...
  public static parse(value: unknown): FhirCoverageEligibilityRequest {
    ...
    return new FhirCoverageEligibilityRequest(parsed as unknown as CoverageEligibilityRequest)
  }
}
