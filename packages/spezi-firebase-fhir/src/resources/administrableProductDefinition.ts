...
export const administrableProductDefinitionSchema = untypedAdministrableProductDefinitionSchema
...
export class FhirAdministrableProductDefinition extends FhirDomainResource<AdministrableProductDefinition> {
  ...
  public static parse(value: unknown): FhirAdministrableProductDefinition {
    ...
    return new FhirAdministrableProductDefinition(parsed as unknown as AdministrableProductDefinition)
  }
}
