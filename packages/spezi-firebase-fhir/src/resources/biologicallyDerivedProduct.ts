...
export const biologicallyDerivedProductSchema = untypedBiologicallyDerivedProductSchema
...
export class FhirBiologicallyDerivedProduct extends FhirDomainResource<BiologicallyDerivedProduct> {
  ...
  public static parse(value: unknown): FhirBiologicallyDerivedProduct {
    ...
    return new FhirBiologicallyDerivedProduct(parsed as unknown as BiologicallyDerivedProduct)
  }
}
