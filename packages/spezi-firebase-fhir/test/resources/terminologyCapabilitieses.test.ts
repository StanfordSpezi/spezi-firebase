...
describe('TerminologyCapabilities Resource', () => {
  it('should validate FHIR terminologyCapabilities from terminologyCapabilitieses.json', () => {
    const data = fs.readFileSync('test/resources/terminologyCapabilitieses.json', 'utf-8')
