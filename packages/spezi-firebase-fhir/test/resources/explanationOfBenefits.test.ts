...
describe('ExplanationOfBenefit Resource', () => {
  it('should validate FHIR explanationOfBenefit from explanationOfBenefits.json', () => {
    const data = fs.readFileSync('test/resources/explanationOfBenefits.json', 'utf-8')
