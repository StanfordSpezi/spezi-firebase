...
describe('RegulatedAuthorization Resource', () => {
  it('should validate FHIR RegulatedAuthorizations from regulatedAuthorizations.json', () => {
    const data = fs.readFileSync('test/resources/regulatedAuthorizations.json', 'utf-8')
