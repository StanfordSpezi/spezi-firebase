...
describe('ChargeItemDefinition Resource', () => {
  it('should validate FHIR chargeItemDefinition from chargeItemDefinitions.json', () => {
    const data = fs.readFileSync('test/resources/chargeItemDefinitions.json', 'utf-8')
