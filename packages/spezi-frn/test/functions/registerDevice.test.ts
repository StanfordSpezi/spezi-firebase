...
import { createRegisterDeviceHandler, RegisterDeviceInput } from '../../src/functions/registerDevice.js';

describe('registerDevice Function', () => {
  let sandbox: SinonSandbox;
  let mockNotificationService: any;
  let registerDeviceHandler: (userId: string, data: RegisterDeviceInput) => Promise<undefined>;
