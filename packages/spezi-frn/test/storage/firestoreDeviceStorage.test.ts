...
describe('FirestoreDeviceStorage', () => {
  ...
  describe('constructor', () => {
    it('should initialize with default options', () => {
      ...
      expect(mockFirestore.collection.calledWith('users/test/devices')).to.be.false;
    });
    ...
    it('should initialize with custom options', () => {
      ...
      expect(mockFirestore.collection.calledWith('custom_users/test/custom_devices')).to.be.true;
    });
  });
  ...
  describe('storeDevice', () => {
    it('should store a new device if no existing device is found', async () => {
      ...
      mockFirestore.runTransaction = sandbox.stub().callsFake(async (transactionCallback: any) => {
      ...
      expect(mockFirestore.collection.calledWith('users/user123/devices')).to.be.true;
    });
