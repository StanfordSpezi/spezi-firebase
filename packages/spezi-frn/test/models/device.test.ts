...
import { Device, DevicePlatform, deviceConverter } from '../../src/models/device.js';
...
describe('Device Model', () => {
  ...
  describe('Constructor', () => {
    it('should create a Device instance with required properties', () => {
      ...
      expect(device.notificationToken).to.equal(validDeviceData.notificationToken);
  ...
  describe('Device Converter', () => {
    it('should encode a Device instance properly', () => {
      ...
      expect(encoded.notificationToken).to.equal(validDeviceData.notificationToken);
